    ...
    <div className={registerStyleModule.registrationDashboard}>
      <div className={registerStyleModule.registerForm}>
        <div className={registerStyleModule.formSection}>
          <h2 className={registerStyleModule.formHeading}>Welcome, <br /> Please register.</h2>
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className={registerStyleModule.name}>
              <CustomsInput
                ...
                register={register}
                errors={errors}
                validation={{ required: "Name required", maxLength: 8, pattern: /^[A-Za-z ]{1,7}$/ }}
              />
              <CustomsInput
            ...
            <CustomsInput
              ...
              register={register}
              errors={errors}
              validation={{ required: "Please enter the phone number", pattern: /^\d{10}$/ }}
            />
            <CustomsInput
              icon={faLock}
              ...
              register={register}
              errors={errors}
              validation={{ required: "Please enter the password", maxLength: 4 }}
            />
            <CustomsInput
              icon={faLock}
              ...
              register={register}
              errors={errors}
              validation={{ required: "Please confirm password", validate: value => value === password || "Passwords do not match" }}
            />
            <div className={registerStyleModule.registerAndLoginLink}>
              <Button type="submit" className={registerStyleModule.signupButton}>
